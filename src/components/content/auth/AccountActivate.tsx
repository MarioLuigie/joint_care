          ...
          Aby aktywować konto postępuj zgodnie z instrukcją.
			...
			<CardContent className="flex flex-col gap-3">
				...
				<div className="text-[14px] font-normal text-[#030303]">
					<p className='pb-4'>Nie dostałeś wiadomości z linkiem? Kliknij w poniższy link a wyślemy ponownie.</p>
					<Link href="#" className='text-[#048AED] underline'>Wyślij ponownie</Link>
				</div>
			</div>
			</CardContent>
		</Card>
